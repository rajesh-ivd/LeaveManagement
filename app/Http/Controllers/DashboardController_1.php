...
class DashboardController_1 extends Controller
{
    public function Dashbord_alldata1(Request $request)
    {
        ...
        $leaveDataQuery = LeaveType::leftJoin('leave_assign', 'leave_type.id', '=', 'leave_assign.leave_type')
        ...
        $responseDataId = [
            'data' => $leaveData->map(function ($leaveID) {
                return [
                    'count' => $leaveID->count,
                    'color' => $leaveID->color,
                    'lid' => $leaveID->lid,
            ...
            'chart' => $leaveData->map(function ($leaveID) {
                return [
